		...
		namespace postgres {
			...
			class query : public sql::query {
				...
				public:
					...
					exported uint8* get_bytes(word column, uint8* buffer, word count);
					exported std::string get_string(word column);
					exported date_time get_date_time(word column);
					exported data_stream get_data_stream(word column);
					exported float64 get_float64(word column);
					exported float32 get_float32(word column);
					exported uint64 get_uint64(word column);
					exported uint32 get_uint32(word column);
					exported uint16 get_uint16(word column);
					exported uint8 get_uint8(word column);
					exported int64 get_int64(word column);
					exported int32 get_int32(word column);
					exported int16 get_int16(word column);
					exported int8 get_int8(word column);
					exported bool get_bool(word column);

					exported uint8* get_bytes(std::string column, uint8* buffer, word count);
					exported std::string get_string(std::string column);
					exported date_time get_date_time(std::string column);
					exported data_stream get_data_stream(std::string column);
					exported float64 get_float64(std::string column);
					exported float32 get_float32(std::string column);
					exported uint64 get_uint64(std::string column);
					exported uint32 get_uint32(std::string column);
					exported uint16 get_uint16(std::string column);
					exported uint8 get_uint8(std::string column);
					exported int64 get_int64(std::string column);
					exported int32 get_int32(std::string column);
					exported int16 get_int16(std::string column);
					exported int8 get_int8(std::string column);
					exported bool get_bool(std::string column);
			};
