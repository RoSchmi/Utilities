...
exported TCPServer* TCPServer_Listen(int8* port, boolean isWebSocket, TCPServer_OnConnect connectCallback, TCPServer_OnReceive receiveCallback, TCPServer_OnDisconnect disconnectCallback);
exported boolean TCPServer_Send(TCPServer_Client* client, uint8* buffer, uint16 length);
exported void TCPServer_DisconnectClient(TCPServer_Client* client);
exported void TCPServer_Shutdown(TCPServer* server);
